          ...
          <div className="column">
            ...
            <div className="footer-links">
              ...
              <div className="link-4">
                <span className="link-5">
                  Download
                </span>
              </div>
              <div className="link-6">
                <span className="link-7">
                  Blog
                </span>
              </div>
          ...
          <div className="column-1">
            ...
            <div className="footer-links-1">
              <div className="link-10">
                <span className="link-11">
                  Demo
                </span>
              </div>
              <div className="link-12">
                <span className="link-13">
                  Customers
                </span>
              </div>
              <div className="link-14">
                <span className="link-15">
                  Live Chat
                </span>
              </div>
              <div className="link-16">
                <span className="link-17">
                  Unlimited support
                </span>
              </div>
              <div className="link-18">
                <span className="link-19">
                  User Analytics
                </span>
              </div>
            </div>
